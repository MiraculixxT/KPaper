...
class ScrollGUI(
    ...
    private val arrowRedL = InventoryUtils.getCustomItem("arrowLeftEnd", 9000, KHeads.ARROW_LEFT_RED, locale)
    private val arrowRedR = InventoryUtils.getCustomItem("arrowRightEnd", 9000, KHeads.ARROW_RIGHT_RED, locale)
    private val arrowGreenL = InventoryUtils.getCustomItem("arrowLeft", 9001, KHeads.ARROW_LEFT_GREEN, locale)
